...
const services = [
  ...
  },
  {
    ...
    link: "oral-&-maxillofacial-surgeries",
  },
  {
    ...
    link: "flap-surgery-with-bone-grafting",
  },
  {
    ...
    link: "surgeries-for-impacted-teeth",
  },
  {
...
const ServiceCard = ({ service, index }) => {
  return (
    ...
    >
      <div className="relative aspect-[4/3] sm:aspect-[4/3] overflow-hidden rounded-t-xl">
        <img
          src={service.image}
          alt={service.title}
      ...
      <div className="p-3 sm:p-6">
        <h3 className="text-base sm:text-xl font-semibold text-[#0d3b66] mb-1 sm:mb-2">
          {service.title}
        </h3>
        <p className="text-gray-600 text-xs sm:text-sm line-clamp-1 sm:line-clamp-2 mb-2 sm:mb-4">
          {service.description}
        </p>
        <Link
